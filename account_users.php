            ...
            <div class="container-fluid dashboard-content"> 
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        $res = mysqli_fetch_assoc($query);
                        ?>
                        <form id="form" class="splash-container" method="post" action="update_users.php"enctype="multipart/form-data">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                         <input class="form-control form-control-lg" type="file" name="file" data-parsley-trigger="change" required="" value="<?php echo $res['image'];?>" placeholder="choose file" autocomplete="off">
                                    </div>
