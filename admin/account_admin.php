                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <?php
                                ...
                                $select2="select * from cake_shop_admin_registrations where admin_username='$admin_username'";
                                $query=mysqli_query($conn,$select2);
                                $res = mysqli_fetch_assoc($query)
                                ?>
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded=""><img src="../uploads/<?php echo $res['image'];?>" alt="" class="user-avatar-md rounded-circle"></a>
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        $res = mysqli_fetch_assoc($query);
                        ?>
                        <form id="form" class="splash-container" method="post" action="update_admin.php" enctype="multipart/form-data">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                         <input class="form-control form-control-lg" type="file" name="file" data-parsley-trigger="change" required="" placeholder="choose file" value="<?php echo $res['image'];?>"autocomplete="off">
                                    </div>
                                    <div class="form-group pt-2">
                                        <input type="hidden" value="<?php echo $res['admin_id'];?>" name="hidden_admin_id">
                                        <button class="btn btn-block btn-primary" name="btn" type="submit">Change</button>
                                    </div>
                                </div>
                            </div>
                        </form>
