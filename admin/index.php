...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="#"><h2 class="text-primary">
            <img class="w-100" src="../uploads/logo.jpeg" alt="Online Cake Shop" style="height:80px;">

            </h2></a><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
