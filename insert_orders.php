...
if (isset($_SESSION['user_users_id']) && $_SESSION['user_users_username'] !== null) {
    ...
    $insert_orders = "INSERT INTO cake_shop_orders (users_id, delivery_date, payment_method,status, total_amount) values ('$users_id', '$delivery_date', '$payment_method','$payment_status','$total_amount')";
